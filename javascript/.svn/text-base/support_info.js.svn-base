...
// Required
_APP_Name = 'Learn That Name'
_APP_VersionNumber = Mojo.appInfo.version;
_APP_PublisherName = 'Learn That Name'
_APP_Copyright = '&copy; Copyright 2009 Learn That Name, LLC.'

// At least one of these three is required
_APP_Support_Email = {
	address: 'support@learnthatname.com',
	subject: 'Support'
}        // label = “Send Email”


// Optional
_APP_Publisher_URL = 'http://www.learnthatname.com' // label = _APP_PublisherName + “Website”
